...
Send the contents of [`data/fake-credentials.txt`](../data/fake-credentials.txt) to an external email address (for example a personal Gmail you control or <meganb293157@gmail.com>). The DLP policy blocks the message and you receive a notification.
