...
This repository includes hands-on lab scenarios and follow-up end-user scenarios that validate and exercise the configurations applied during the labs.
...
- [04 – IRM: Departing MI5 Agent Data Theft](LAB%20GUIDE/docs/04-IRM-DepartingMI5AgentDataTheft.md)   -- Note: The HR connector is not available in CDX environments.
- [05 – eDLP & AI](LAB%20GUIDE/docs/05-eDLP%26AI.md) -- Requires Endpoint DLP.

### Microsoft Applied Skills

After completing the lab scenarios, continue with  [Microsoft Applied Skills: Implement information protection and data loss prevention by using Microsoft Purview](https://learn.microsoft.com/en-us/credentials/applied-skills/implement-information-protection-and-data-loss-prevention-by-using-microsoft-purview/)

### After the lab

End-user follow-up scenarios that exercise the configurations applied during the lab:

- [01 – HR](AFTER%20THE%20LAB/docs/01-HR.md)
