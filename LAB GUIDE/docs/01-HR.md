...
- Character proximity: leave default value of `300`
- Supporting elements — Groups: **Any of these** > Add more > **Functions**: (Or if you want to add just add one of them use 'Func_finnish_national_id') 
...
6. **Settings** — select both:
   ...
   ![Downgrade-justification settings enabled](../images/publishing-settings.png)
